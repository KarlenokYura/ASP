    ...
    <head >
        ...
        <body>    
            ...
            function sum() {
                ...
                let sUrl = "http://localhost:3000/Lab02/sum.KYA";
           ...
           function mul() {
               ...
               let sUrl = "http://localhost:3000/Lab02/mul.KYA";
                oReq.open("POST", sUrl, true);
                oReq.send(data);
                oReq.onreadystatechange = function () {
                    if (oReq.readyState == 4 && oReq.status == 200) {
           ...
           <form action="http://localhost:3000/Lab02/mul.KYA?X=2&Y=40" method="post" style="margin-top: 10px">
